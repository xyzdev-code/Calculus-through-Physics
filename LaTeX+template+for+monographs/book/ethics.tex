...
Use the template \texttt{ethics.tex} together with the document class \texttt{SNmono.cls} (monograph-type books) or \texttt{SNmult.cls} (edited books) for ethical declarations such as:
