...
\end{enumerate}
The \textit{styling} of references\footnote{Always use the standard abbreviation of a journal's name according to the ISSN \textit{List of Title Word Abbreviations}, see \url{https://www.issn.org/services/online-services/access-to-the-ltwa/}} depends on the subject of your book:
\begin{itemize}
