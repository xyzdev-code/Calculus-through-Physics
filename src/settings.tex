...
\titleformat{\chapter}[display]
  ...
  \parbox[b]{\dimexpr\textwidth-4.8em\relax}{\raggedright\MakeUppercase{#1}}{\hfill\fontsize{70}{60}\thechapter}
  }
  []
...
\newenvironment{essproblem}{
  \refstepcounter{problem}
  \hrule 
  \textbf{* Problem \thechapter.\arabic{problem}}
}{\vspace{2pt}\hrule}
\newenvironment{midproblem}{
  \refstepcounter{problem}
  \hrule 
  \textbf{** Problem \thechapter.\arabic{problem}}
}{\vspace{2pt}\hrule}
\newenvironment{hardproblem}{
  \refstepcounter{problem}
  \hrule 
  \textbf{*** Problem \thechapter.\arabic{problem}}
}{\vspace{2pt}\hrule}
\newenvironment{normproblem}{
  \refstepcounter{problem}
  \hrule 
  \textbf{Problem \thechapter.\arabic{problem}}
}{\vspace{2pt}\hrule}
...
\tcbset{
	...
	defstyle/.style={
    common={xpurple}{\(\bigstar\)},
    label={Definition \thetcbcounter}
	},
	theoremstyle/.style={
    common={xgraycyan}{\textbf{QED}},
	},
	lemmastyle/.style={
    common={xgrayblue}{\textbf{QED}},
    label=Lemma \thetcbcounter
	},
	proofstyle/.style={
		common={xgreen}{\textbf{QED}},
	},
	examplestyle/.style={
    common={xblue}{\(\bigtriangleup\)},
	},
	notestyle/.style={
		common={xred}{\textbf{!}},
	},
...
\newtcbtheorem[auto counter, number within=chapter]{remark}{Remark}{exercisestyle}{remark}
%---------%
% FIGURES %
%---------%
