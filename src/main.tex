...
\input{settings}
\usepackage{pgfplots, caption, fancyhdr, cleveref, lipsum, gensymb, indentfirst, marginnote, enumitem, graphicx, esdiff, pdfpages, amsmath}
\usepackage{newtx}
\usepackage{perpage}
...
\flushbottom
  ...
  Furthermore, to prevent confusion on sidenotes\sidenote{\footnotesize \textit{This is a sidenote.}} and indices, sidenote markers are \textbf{bolded} while the latter is not.
  \flushbottom
