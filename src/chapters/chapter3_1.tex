...
\begin{Exercise}
  \begin{enumerate}
    ...
    \item{Find the derivative of \(\sin(x)\). (Hint: \(sin(a+b)=sin(a)cos(b)+cos(a)sin(b)\)).}
    \item{\textbf{(Difficult)} Let \(f(x)=(x-1)(x-2)\cdots(x-1729)\), find \(f'(1729)\). \textit{(Adapted from SMO 2025 Senior Section Round 1).}}
  \end{enumerate}
\end{Exercise}
